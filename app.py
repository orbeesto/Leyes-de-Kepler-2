...
st.write("Visualización en 3D basada en elementos orbitales J2000.")
...
def get_3d_pos(p_name, days):
    ...
    # Transformación a coordenadas eclípticas (3D)
...
# --- INTERFAZ ---
dias = st.slider("Días desde el inicio de la simulación", 0, 1000, 0)
...
for name, data in planets.items():
    ...
    fig.add_trace(go.Scatter3d(x=pts[:,0], y=pts[:,1], z=pts[:,2], mode='lines', line=dict(color=data['color'], width=2), name=f"Órbita {name}"))
